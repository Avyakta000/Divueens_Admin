...
const Navbar = () => {
    ...
    return (
        <nav className="sticky top-0 z-50 flex justify-between min-h-[12vh] items-center py-2 px-[.5rem] text-black bg-white border-b-pink-400 border-2 md:flex-row flex-col">
